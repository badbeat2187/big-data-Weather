...
public class MinRainPerYear 
{
    public static class MinRainPerYearMapper extends MapReduceBase implements
    ...
    public static class MinRainPerYearReducer extends MapReduceBase implements
    ...
    {      
        JobConf jobConfiguration = new JobConf(MinRainPerYear.class);
        ...
        jobConfiguration.setMapperClass(MinRainPerYearMapper.class); 
        jobConfiguration.setReducerClass(MinRainPerYearReducer.class);
